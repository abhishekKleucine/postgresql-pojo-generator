...
/**
 * Enhanced row mapper for PasswordPolicie entity
 * Generated by Enhanced JDBC DAO Generator
 */
public class PasswordPolicieRowMapper implements RowMapper<PasswordPolicie> {

    @Override
    public PasswordPolicie mapRow(ResultSet rs, int rowNum) throws SQLException {
        PasswordPolicie entity = new PasswordPolicie();
