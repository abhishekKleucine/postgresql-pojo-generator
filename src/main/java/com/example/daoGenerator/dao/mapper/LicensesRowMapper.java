...
/**
 * Row mapper for Licenses entity
...
public class LicensesRowMapper implements RowMapper<Licenses> {
    ...
    public Licenses mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        entity.setSubscriptionRenewalDate(rs.getString("subscription_renewal_date"));
        entity.setModifiedBy(rs.getLong("modified_by"));
        entity.setId(rs.getLong("id"));
        entity.setSubscriptionStartDate(rs.getString("subscription_start_date"));
