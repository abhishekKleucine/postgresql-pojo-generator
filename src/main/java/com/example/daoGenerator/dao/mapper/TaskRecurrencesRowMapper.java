...
/**
 * Enhanced row mapper for TaskRecurrences entity
 * Generated by Enhanced JDBC DAO Generator
 */
public class TaskRecurrencesRowMapper implements RowMapper<TaskRecurrences> {

    private final ObjectMapper objectMapper = new ObjectMapper();

    @Override
    public TaskRecurrences mapRow(ResultSet rs, int rowNum) throws SQLException {
        TaskRecurrences entity = new TaskRecurrences();
