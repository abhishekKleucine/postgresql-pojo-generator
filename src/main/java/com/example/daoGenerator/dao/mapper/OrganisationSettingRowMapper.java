...
/**
 * Enhanced row mapper for OrganisationSetting entity
 * Generated by Enhanced JDBC DAO Generator
 */
public class OrganisationSettingRowMapper implements RowMapper<OrganisationSetting> {

    private final ObjectMapper objectMapper = new ObjectMapper();

    @Override
    public OrganisationSetting mapRow(ResultSet rs, int rowNum) throws SQLException {
        OrganisationSetting entity = new OrganisationSetting();
