...
/**
 * Enhanced row mapper for ChecklistAudit entity
 * Generated by Enhanced JDBC DAO Generator
 */
public class ChecklistAuditRowMapper implements RowMapper<ChecklistAudit> {

    @Override
    public ChecklistAudit mapRow(ResultSet rs, int rowNum) throws SQLException {
        ChecklistAudit entity = new ChecklistAudit();
