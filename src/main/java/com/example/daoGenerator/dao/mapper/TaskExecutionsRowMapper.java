...
/**
 * Enhanced row mapper for TaskExecutions entity
 * Generated by Enhanced JDBC DAO Generator
 */
public class TaskExecutionsRowMapper implements RowMapper<TaskExecutions> {

    @Override
    public TaskExecutions mapRow(ResultSet rs, int rowNum) throws SQLException {
        TaskExecutions entity = new TaskExecutions();
