...
/**
 * Enhanced row mapper for Schedulers entity
 * Generated by Enhanced JDBC DAO Generator
 */
public class SchedulersRowMapper implements RowMapper<Schedulers> {

    private final ObjectMapper objectMapper = new ObjectMapper();

    @Override
    public Schedulers mapRow(ResultSet rs, int rowNum) throws SQLException {
        Schedulers entity = new Schedulers();
