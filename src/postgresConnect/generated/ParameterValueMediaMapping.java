...
/**
 * Advanced POJO class for table: parameter_value_media_mapping
 ...
 * 
 * Check Constraints:
 * - 2200_221662_6_not_null: created_by IS NOT NULL
 * - 2200_221662_4_not_null: created_at IS NOT NULL
 * - 2200_221662_2_not_null: parameter_values_id IS NOT NULL
 * - 2200_221662_1_not_null: medias_id IS NOT NULL
 * - 2200_221662_5_not_null: modified_at IS NOT NULL
 * - 2200_221662_7_not_null: modified_by IS NOT NULL
 * 
 * Foreign Keys:
 * - medias_id → medias.id
...
public class ParameterValueMediaMapping implements Serializable {
     ...
     */
    public ParameterValueMediaMapping(Long mediasId, Long parameterValuesId, Boolean archived, Long createdAt, Long modifiedAt, Long createdBy, Long modifiedBy) {
