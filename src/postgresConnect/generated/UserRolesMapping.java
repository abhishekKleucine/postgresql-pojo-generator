...
/**
 * Advanced POJO class for table: user_roles_mapping
 ...
 * 
 * Check Constraints:
 * - 2200_222882_2_not_null: users_id IS NOT NULL
 * - 2200_222882_3_not_null: created_at IS NOT NULL
 * - 2200_222882_1_not_null: roles_id IS NOT NULL
 * 
 * Foreign Keys:
 * - roles_id → roles.id
 * - users_id → users.id
...
public class UserRolesMapping implements Serializable {
     ...
     */
    public UserRolesMapping(Long rolesId, Long usersId, Long createdAt, Long createdBy) {
