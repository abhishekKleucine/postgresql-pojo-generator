...
/**
 * Advanced POJO class for table: parameter_values
 ...
 * 
 * Check Constraints:
 * - 2200_221666_8_not_null: created_at IS NOT NULL
 * - 2200_221666_21_not_null: has_exceptions IS NOT NULL
 * - 2200_221666_10_not_null: created_by IS NOT NULL
 * - 2200_221666_6_not_null: jobs_id IS NOT NULL
 * - 2200_221666_20_not_null: has_corrections IS NOT NULL
 * - 2200_221666_7_not_null: parameters_id IS NOT NULL
 * - 2200_221666_1_not_null: id IS NOT NULL
 * 
 * Foreign Keys:
 * - jobs_id → jobs.id
...
public class ParameterValues implements Serializable {
    ...
    public ParameterValues() {
        ...
        this.hasCorrections = false; // Default value
        this.hasExceptions = false; // Default value
        this.hasActiveException = false; // Default value
    }
     ...
     * @param hasCorrections has_corrections
     * @param hasExceptions has_exceptions
     * @param hasActiveException has_active_exception
     */
    public ParameterValues(Long id, String value, String reason, String state, String choices, Long jobsId, Long parametersId, Long createdAt, Long modifiedAt, Long createdBy, Long modifiedBy, Long parameterValueApprovalId, Boolean hidden, String impactedBy, Boolean verified, Long taskExecutionsId, Boolean hasVariations, Long clientEpoch, Long version, Boolean hasCorrections, Boolean hasExceptions, Boolean hasActiveException) {
        this.id = id;
        this.value = value;
        this.reason = reason;
        this.state = state;
    ...
    /**
     * Gets the value of has_corrections
     * @return Boolean value of has_corrections
     */
    ...
    /**
     * Sets the value of has_corrections
     * @param hasCorrections new value for has_corrections
     * @throws IllegalArgumentException if value is null (NOT NULL constraint)
     */
    ...
    /**
     * Gets the value of has_exceptions
     * @return Boolean value of has_exceptions
     */
    ...
    /**
     * Sets the value of has_exceptions
     * @param hasExceptions new value for has_exceptions
     * @throws IllegalArgumentException if value is null (NOT NULL constraint)
     */
    ...
    /**
     * Gets the value of has_active_exception
     * @return Boolean value of has_active_exception
     */
    ...
    /**
     * Sets the value of has_active_exception
     * @param hasActiveException new value for has_active_exception
     */
    ...
    public java.util.List<String> validateConstraints() {
        ...
        if (this.hasCorrections == null) {
            violations.add("has_corrections cannot be null");
        }
        if (this.hasExceptions == null) {
            violations.add("has_exceptions cannot be null");
        }
        return violations;
    }
