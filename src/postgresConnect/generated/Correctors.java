...
/**
 * Advanced POJO class for table: correctors
 ...
 * 
 * Check Constraints:
 * - 2200_221516_9_not_null: modified_at IS NOT NULL
 * - 2200_221516_4_not_null: corrections_id IS NOT NULL
 * - 2200_221516_8_not_null: modified_by IS NOT NULL
 * - 2200_221516_6_not_null: created_by IS NOT NULL
 * - 2200_221516_7_not_null: created_at IS NOT NULL
 * - 2200_221516_1_not_null: id IS NOT NULL
 * - 2200_221516_5_not_null: action_performed IS NOT NULL
 * 
 * Foreign Keys:
...
public class Correctors implements Serializable {
     ...
     */
    public Correctors(Long id, Long userGroupsId, Long usersId, Long correctionsId, Boolean actionPerformed, Long createdBy, Long createdAt, Long modifiedBy, Long modifiedAt) {
        this.id = id;
