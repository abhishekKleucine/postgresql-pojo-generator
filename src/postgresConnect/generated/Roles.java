...
/**
 * Advanced POJO class for table: roles
 ...
 * 
 * Unique Constraints:
 * - uksclfxide2pa64qcuo9wkr5pq: archived
 * - uksclfxide2pa64qcuo9wkr5pq: services_id
 * - uksclfxide2pa64qcuo9wkr5pq: name
 * 
 * Check Constraints:
 * - 2200_221802_4_not_null: modified_at IS NOT NULL
 * - 2200_221802_6_not_null: archived IS NOT NULL
 * - 2200_221802_2_not_null: created_at IS NOT NULL
 * - 2200_221802_1_not_null: id IS NOT NULL
 * 
 * Foreign Keys:
 * - created_by → users.id
...
public class Roles implements Serializable {
     ...
     * Default: false
     * Unique Constraint: uksclfxide2pa64qcuo9wkr5pq
     */
     ...
     */
    public Roles(Long id, Long createdAt, Long createdBy, Long modifiedAt, Long modifiedBy, Boolean archived, String name, String servicesId) {
        this.id = id;
     ...
     * @throws IllegalArgumentException if value is null (NOT NULL constraint)
     * Note: Value must be unique (uksclfxide2pa64qcuo9wkr5pq)
     */
