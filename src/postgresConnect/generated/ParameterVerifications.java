...
/**
 * Advanced POJO class for table: parameter_verifications
 ...
 * 
 * Check Constraints:
 * - 2200_221678_6_not_null: verification_type IS NOT NULL
 * - 2200_221678_3_not_null: jobs_id IS NOT NULL
 * - 2200_221678_11_not_null: users_id IS NOT NULL
 * - 2200_221678_1_not_null: id IS NOT NULL
 * - 2200_221678_7_not_null: created_at IS NOT NULL
 * - 2200_221678_9_not_null: modified_by IS NOT NULL
 * - 2200_221678_5_not_null: verification_status IS NOT NULL
 * - 2200_221678_10_not_null: modified_at IS NOT NULL
 * - 2200_221678_4_not_null: parameter_values_id IS NOT NULL
 * - 2200_221678_8_not_null: created_by IS NOT NULL
 * 
 * Foreign Keys:
 * - jobs_id → jobs.id
...
public class ParameterVerifications implements Serializable {
     ...
     */
    public ParameterVerifications(Long id, String comments, Long jobsId, Long parameterValuesId, String verificationStatus, String verificationType, Long createdAt, Long createdBy, Long modifiedBy, Long modifiedAt, Long usersId, Long userGroupsId, Boolean isBulk) {
        this.id = id;
